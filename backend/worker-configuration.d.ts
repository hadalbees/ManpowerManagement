/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2fddf22358d67469f9c0cf3172fab471)
...
declare global {
	...
	const JWT_REFRESH_EXPIRATION: string;
	const DATABASE_ENCRYPTION_KEY_256: string;
